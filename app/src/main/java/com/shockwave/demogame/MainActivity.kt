...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    internal class splashhandler(val activity: MainActivity) : Runnable {
        override fun run() {
            val unused: Int = activity.beautyIndex
            var i = 500
            var i2 = R.drawable.beauty_8
            when (unused + 1) {
                0 -> i2 = R.drawable.beauty_1
                1 -> i2 = R.drawable.beauty_2
                2 -> {
                    i = 300
                    i2 = R.drawable.beauty_3
                }
                3 -> {
                    i = 400
                    i2 = R.drawable.beauty_4
                }
                4 -> {
                    i = 100
                    i2 = R.drawable.beauty_5
                }
                5 -> {
                    i = 800
                    i2 = R.drawable.beauty_6
                }
                6 -> {
                    i = 1000
                    i2 = R.drawable.beauty_7
                }
                7 -> i2 = R.drawable.beauty_8
            }
